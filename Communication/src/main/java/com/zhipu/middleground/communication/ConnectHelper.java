...
public class ConnectHelper {
    private static final String TAG = BluetoothHelper.TAG;
    ...
    public synchronized void connect(String address, boolean secure) {
        ...
        mConnectThread = new ConnectThread(mBluetoothDevice, secure);
    ...
    private void onConnectResponse() {
        if (mOnConnectListener != null) {
            mOnConnectListener.onConnect(mBluetoothDevice);
        }
    }

    private void onDisconnectResponse() {
        if (mOnConnectListener != null) {
            mOnConnectListener.onDisconnect(mBluetoothDevice, mDisconnectReason);
        }
    }
